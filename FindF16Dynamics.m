...
%%
C_longitude_hi = mat_hi([21 23 25 26 29 37], [3 5 7 8 11 13 14]);
C_longitude_lo = mat_lo([21 23 25 26 29 37], [3 5 7 8 11 13 14]);

%% Select the components that make up the longitude D matrix
%%
D_longitude_hi = mat_hi([21 23 25 26 29 37], [19 20]);
D_longitude_lo = mat_lo([21 23 25 26 29 37], [19 20]);
